...
export const sharedRuntimeEnvKeys = {
  ...
  mysqlDsn: 'SMARTCLOUD_MYSQL_DSN',
  redisUrl: 'SMARTCLOUD_REDIS_URL',
  minioEndpoint: 'SMARTCLOUD_MINIO_ENDPOINT',
  minioBucket: 'SMARTCLOUD_MINIO_BUCKET',
  minioAccessKey: 'SMARTCLOUD_MINIO_ACCESS_KEY',
  minioSecretKey: 'SMARTCLOUD_MINIO_SECRET_KEY',
