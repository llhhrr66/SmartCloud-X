请阅读 /home/ljr/SmartCloud-X/project_document/marketing-service-development-prompt-2026-04-21.md 并按照其中指示完成 marketing-service 开发任务。
...
4. 只有在以下两种情况之一才允许停止：
   - 所有可完成任务均已真正完成；
   - 只剩真实 blocked 项，且你已按原提示词的尝试次数要求完成多轮修复。
